...
<?php
$element_text = ['All Posts','Active Posts', 'Draft Post', 'Comments', 'Unapprove Comment', 'Users', 'Subcriber', 'Categories'];
 $element_count = [$post_count, $post_published_count, $post_draft_count, $comment_count, $unapprove_count, $user_count, $subcriber_count, $category_count];
